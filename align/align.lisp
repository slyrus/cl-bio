...
(defparameter *blosum-62*
  (parse-matrix (read (open (ch-asdf:asdf-lookup-path "asdf:/cl-bio/align/matrix/blosum62")))))
...
(macrolet ((global-align-score-mac (m n i j k l score-fn)
  ...
  (def-global-align-fun %global-align-dna na-score))
...
(defgeneric global-align-dna (seq1 seq2))
(defmethod global-align-dna ((seq1 dna-sequence-with-residues)
                            (seq2 dna-sequence-with-residues))
